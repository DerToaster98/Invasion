...
import invasion.client.render.animation.ModelAnimator;
...
public class ModelBird extends ModelBase {
    private final ModelAnimator animationWingFlap;
    ...
    private final ModelRenderer ltoeR;
    private final ModelRenderer btoeR;
    private final ModelRenderer rtoeR;
    private final ModelRenderer thighR;
    private final ModelRenderer legL;
    private final ModelRenderer ltoeL;
    private final ModelRenderer btoeL;
    private final ModelRenderer rtoeL;
