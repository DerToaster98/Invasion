...
public class ModItems {
    ...
    public static final RegistryObject<Item> DAMPING_AGENT = ITEMS.register("catalyst_mixture", () -> new Item(new Item.Properties().group(ModItemGroups.INVASION).maxStackSize(1)));
    public static final RegistryObject<Item> STABLE_DAMPING_AGENT = ITEMS.register("stable_catalyst_mixture", () -> new Item(new Item.Properties().group(ModItemGroups.INVASION).maxStackSize(1)));
    public static final RegistryObject<Item> STRONG_DAMPING_AGENT = ITEMS.register("strong_catalyst_mixture", () -> new Item(new Item.Properties().group(ModItemGroups.INVASION).maxStackSize(1)));
    ...
    public static final RegistryObject<Item> PROBE = ITEMS.register("probe", () -> new ProbeItem(new Item.Properties().group(ModItemGroups.INVASION)));
    public static final RegistryObject<Item> DEBUG_WAND = ITEMS.register("debug_wand", DebugWandItem::new);
