...
public class ModItems {
    ...
    public static final RegistryObject<Item> ADJUSTER = ITEMS.register("nexus_adjuster", () -> new AdjusterItem(new Item.Properties().group(ModItemGroups.INVASION).maxStackSize(1)));
    public static final RegistryObject<Item> PROBE = ITEMS.register("probe", () -> new ProbeItem(new Item.Properties().group(ModItemGroups.INVASION).maxStackSize(1)));
