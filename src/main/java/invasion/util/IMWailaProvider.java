...
//
//import invmod.common.nexus.NexusBlock;
//import invmod.common.nexus.Invasion;
//
...
//		Invasion teNexus = (Invasion)accessor.getTileEntity();
//		if (teNexus != null){
//				if(teNexus.isActive()){
...
//		registrar.registerBodyProvider(new IMWailaProvider(), NexusBlock.class);
//	}
//
//}
