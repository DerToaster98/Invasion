...
public class PathfinderIM {
    ...
    private static final PathfinderIM pathfinder = new PathfinderIM();
    private IBlockAccess worldMap;
    private final NodeContainer path;
    private final IntHashMap<PathNode> pointMap;
    private final PathNode[] pathOptions;
