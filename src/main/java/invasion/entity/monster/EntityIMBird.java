...
import invasion.client.render.animation.util.FlyState;
import invasion.client.render.animation.util.LegController;
import invasion.client.render.animation.util.MouthController;
import invasion.client.render.animation.util.WingController;
...
public class EntityIMBird extends EntityIMFlying {
    ...
    private static final DataParameter<Integer> ANIMATION_FLAGS = EntityDataManager.createKey(EntityIMBird.class, DataSerializers.VARINT);
    private final AnimationState animationRun;
    private final AnimationState animationFlap;
    private final AnimationState animationBeak;
    private final WingController wingController;
    private final LegController legController;
    private final MouthController beakController;
    ...
    public EntityIMBird(World world, Nexus nexus) {
        super(world, nexus);
