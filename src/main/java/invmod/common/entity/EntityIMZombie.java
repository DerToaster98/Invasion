...
public class EntityIMZombie extends EntityIMMob implements ICanDig
{
    ...
    protected boolean chargeAttack(Entity entity)
    {
        ...
        entity.addVelocity(-MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F) * knockback * 0.5F, 0.4D, MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F) * knockback * 0.5F);
        setSprinting(false);
