...
public class EntityAICreeperIMSwell extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        return (this.theEntity.getCreeperState() > 0) || ((entityliving != null) && (this.theEntity.getDistanceSqToEntity(entityliving) < 9.0D) && ((entityliving.getClass() == EntityPlayer.class) || (entityliving.getClass() == EntityPlayerMP.class) || (entityliving.getClass() == EntityIMWolf.class)));
    }
