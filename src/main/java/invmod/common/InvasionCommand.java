...
public class InvasionCommand extends CommandBase
{
    public void processCommand(ICommandSender sender, String[] args)
    {
        ...
        if ((args.length > 0) && (args.length <= 7))
        {
            ...
            {
                sender.sendChatToPlayer(ChatMessageComponent.createFromText("--- Showing Invasion help page 1 of 1 ---"));
                sender.sendChatToPlayer(ChatMessageComponent.createFromText("/begin x to start a wave"));
                sender.sendChatToPlayer(ChatMessageComponent.createFromText("/end to end the invasion"));
                sender.sendChatToPlayer(ChatMessageComponent.createFromText("/range x to set the spawn range"));
            }
            ...
            {
                sender.sendChatToPlayer(ChatMessageComponent.createFromText("Command not recognised, use /invasion help for a list of all the available commands"));
            }
        }
    }
