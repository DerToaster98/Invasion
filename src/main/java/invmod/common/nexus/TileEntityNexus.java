...
//            }
    ...
    private void stop()
    {
        ...
        {
            setMode(0);
            Block.blocksList[this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord)].setHardness(3.0F);
        }
    ...
    private void bindPlayers()
    {
        ...
        for (EntityPlayer entityPlayer : players)
        {
            ...
            {
                mod_Invasion.sendMessageToPlayers(this.getBoundPlayers(), entityPlayer.username + (entityPlayer.username.toLowerCase().endsWith("s") ? "'" : "'s") + " life is now bound to the nexus");
            }
