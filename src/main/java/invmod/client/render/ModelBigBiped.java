...
public class ModelBigBiped extends ModelBase
{
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
    {
        ...
        if (this.onGround > -9990.0F)
        {
            ...
            this.body.rotateAngleY = (MathHelper.sin(MathHelper.sqrt_float(f) * (float)Math.PI * 2.0F) * 0.2F);
            ...
            float f4 = MathHelper.sin(this.onGround * (float)Math.PI) * -(this.head.rotateAngleX - 0.7F) * 0.75F;
