...
//    this.lhorn.render(f5);
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity)
    {
        ...
        this.leftleg.rotateAngleX = (MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1 - 0.15919F);
        this.lshin.rotateAngleX = (MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1 + 0.82461F);
        this.lfoot.rotateAngleX = (MathHelper.cos(f * 0.6662F + (float)Math.PI) * 1.4F * f1 - 0.01214F);
        this.rightleg.rotateAngleY = 0.0F;
        this.rshin.rotateAngleY = 0.0F;
        this.rfoot.rotateAngleY = 0.0F;
        this.leftleg.rotateAngleY = 0.0F;
